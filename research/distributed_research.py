...
def factor_research(symbol, period="6mo"):
    ...
    try:
        ...
        alpha_score = momentum * 0.4 + sharpe * 0.4 - volatility * 0.2
        ...
        return {
            ...
            "Alpha Score": round(alpha_score, 4),
        }
...
class DistributedResearch:
    ...
    def run_research(self, symbols, workers=8):

        self.queue.start_workers(num_workers=workers)

        for symbol in symbols:
            self.queue.add_task(factor_research, symbol)
