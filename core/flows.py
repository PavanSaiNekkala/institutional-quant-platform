...
def flow_momentum(flow_series, window=20):

    momentum = flow_series.pct_change(window)
...
def smart_money_score(volume_z, ad_momentum, obv_momentum):

    score = 0.4 * volume_z + 0.3 * ad_momentum + 0.3 * obv_momentum
