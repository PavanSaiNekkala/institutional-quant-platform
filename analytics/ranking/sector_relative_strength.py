...
rs_df["Symbol"] = (
    rs_df["Symbol"].astype(str).str.replace(".NS", "", regex=False).str.upper().str.strip()
)

meta_df["Symbol"] = (
    meta_df["Symbol"].astype(str).str.replace(".NS", "", regex=False).str.upper().str.strip()
)
...
numeric_cols = ["RS_5D", "RS_15D", "RS_30D", "RS_60D", "RS_ACCELERATION", "VOL_ADJ_RS"]
...
sector_df = sector_df.sort_values(by=["SECTOR_SCORE", "AVG_RS_30D"], ascending=False)

# =========================================================
# SECTOR RANK
# =========================================================

sector_df["SECTOR_RANK"] = range(1, len(sector_df) + 1)
