...
conviction = (
    pd.read_csv(CONVICTION_FILE)
    if CONVICTION_FILE.exists()
    else pd.DataFrame()
)

expected = (
    pd.read_csv(EXPECTED_FILE)
    if EXPECTED_FILE.exists()
    else pd.DataFrame()
)

news = (
    pd.read_csv(NEWS_FILE)
    if NEWS_FILE.exists()
    else pd.DataFrame()
)
...
if (
    ...
    if (
        not conviction.empty
        and
        "CONVICTION"
        in conviction.columns
    ):
