...
from core.dashboard_data_loader import load_portfolio_analytics
...
if portfolio_df.empty:
    st.warning("No portfolio analytics available.")
...
if "Portfolio Value" in portfolio_df.columns:
    latest_value = portfolio_df["Portfolio Value"].iloc[-1]
